  ...
  return (
    <div className='w-[90vw] md:w-[35vw] p-7 flex flex-col justify-center'>
      <h3 className="text-xl font-bold text-black">
        Start a New Chapter in Learning
      </h3>
      <p className="cc mb-4 text-gray-600 text-md">
        Design your own course and make a difference.Fill in the details below to create a new session.
      </p>
      <form onSubmit={handleCreateSession} className='flex flex-col gap-3'> 
        ...
        <Input
          ...
          type="text"
          placeholder="{Comma-separated, e.g., React, Node.js, Algorithms and Data Structures}"
